<div id="content-page" class="content group">
    <div class="hentry group">
        <form id="contact-form-contact-us" class="contact-form" method="post" action="{{ route('contact.post') }}" enctype="multipart/form-data">
            ...
            <fieldset>
                <ul>
                    ...
                    <li class="submit-button">
                        ...
                        <input type="submit" id="sendmail" name="yit_sendmail" value="Send Message" class="sendmail alignright" />
                    </li>
                </ul>
            </fieldset>
        </form>
