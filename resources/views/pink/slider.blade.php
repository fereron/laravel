...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
    <ul class="slider">
        ...
        @foreach($sliders as $slider)
            <li>
                <div class="slide-holder" style="background:  url('{{ asset(env('THEME')) }}/images/slider-cycle/{{ $slider->img }}') no-repeat center center" style="height:483px;">
    ...
    <div id="yit-widget-area" class="group">
        <div class="yit-widget-content inner group">
            ...
            <div class="yit-widget widget col1_4 one-fourth col widget-last-post group">
                ...
                <div>
                    <h3><a class="text-color" href="{{ route('blog') }}" title="">{{ trans('site.blog_news') }}</a></h3>
                    <p>Section shortcodes &amp; sticky posts! <a href="{{ route('blog') }}"> | more →</a></p>
                </div>
            </div>
